...
public class WeatherAcitivity extends AppCompatActivity {
    ...
    private void backgroundFitSystem() {
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid="
                + weatherId + "&key=b69a206b371546fe9379a8695be85959";
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(WeatherAcitivity.this, "获取天气失败", Toast.LENGTH_SHORT).show();
